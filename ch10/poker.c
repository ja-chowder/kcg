...
void analyze_hand(void) 
{
    ...
    if (high_card_int >= 8) {
        switch (high_card_int) {
            case 12: high_card_ch = 'A'; break;
            case 11: high_card_ch = 'K'; break;
            case 10: high_card_ch = 'Q'; break;
            case  9: high_card_ch = 'J'; break;
            case  8: high_card_ch = 'T'; break;
        }
    }
}
...
void print_results(void)
{
    ...
    else if (high_card_int >= 8)    printf("High card %c", high_card_ch);
    else                            printf("High card %d", high_card_int + 2);
